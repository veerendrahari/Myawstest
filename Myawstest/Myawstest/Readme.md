...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Myawstest*):
...
Execute unit tests
```
    cd "Myawstest/test/Myawstest.Tests"
    dotnet test
```

Deploy application
```
    cd "Myawstest/src/Myawstest"
